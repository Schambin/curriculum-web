      ...
      <main className="container mx-auto px-4 py-8">
        <header className="text-center mb-12">
          ...
          <div className="flex justify-center space-x-4 mb-4">
            <a href="tel:+5569993988887" className="text-gray-700 300 hover:text-gray-800 flex items-center">
              <Phone size={20} className="mr-2" />
              (69) 9 9398-8887
            </a>
            <a href="mailto:schamberkauan@gmail.com" className="text-gray-700 300 hover:text-gray-800 flex items-center">
        ...
        <section className="bg-white rounded-lg shadow-md p-6 mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 100 mb-4 flex items-center border-l-4 border-gray-300 pl-3">Resumo</h2>
        ...
        <section className="bg-white rounded-lg shadow-md p-6 mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 100 mb-4 flex items-center border-l-4 border-gray-300 pl-3">
            <Code className="mr-2" />
            Habilidades
          </h2>
          <ul className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {[
              ...
              <li 
                key={index} 
                className={`bg-gray-100 rounded-full px-4 py-2 text-center text-gray-800 200 border border-gray-200 transition-colors duration-200 hover:bg-gray-200 hover:text-gray-900${
        ...
        <section className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-xl font-semibold text-gray-700 200">Gerente de Desenvolvimento de Sistemas | Norte Tel – Pimenta Bueno/RO</h3>
              <p className="text-gray-600 400 mb-2">07/2022 - Atualmente</p>
              <p className="text-gray-700 300">
            ...
            <div>
              <h3 className="text-xl font-semibold text-gray-700 200">Desenvolvedor Full Stack | Freelancer</h3>
              <p className="text-gray-600 400 mb-2">07/2024 - 08/2024</p>
              <p className="text-gray-700 300">
              ...
              <p className="text-gray-600 400">Repositórios: Schambin/signin-web | Schambin/signin-api</p>
            </div>
            <div>
              <h3 className="text-xl font-semibold text-gray-700 200">Desenvolvedor Full Stack | NorteTel</h3>
              <p className="text-gray-600 400 mb-2">09/2024 - 10/2024</p>
              <p className="text-gray-700 300">
        ...
        <section className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <ul className="space-y-4">
            <li>
              <h3 className="text-xl font-semibold text-gray-700 200">Engenharia de Software – Cruzeiro do Sul</h3>
              <p className="text-gray-600 400">01/2023 – 01/2026</p>
            </li>
            <li>
              <h3 className="text-xl font-semibold text-gray-700 200">Desenvolvedor FullStack – RocketSeat</h3>
              <p className="text-gray-600 400">01/2024 – 01/2025</p>
            </li>
          </ul>
        </section>
        ...
        <section className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <ul className="list-disc list-inside text-gray-700 300 space-y-2">
        ...
        <section className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <div>
            <h3 className="text-xl font-semibold text-gray-700 200">Professor | NorteTel</h3>
            <p className="text-gray-600 mb-2">09/2024 – 09/2024</p>
